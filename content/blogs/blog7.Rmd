...
description: Is life expactancy influenced by the HIV rate?
draft: false
image: pic09.jpg
keywords: ""
slug: blog7
title: HIV Rate, Life Expectancy, Fertility Rate and GDP
...
The purpose of this project is to analyze the relationship between HIV rate, life expectancy and GDP per capita by regions. 
...
region_missing <- hiv_clean %>% 
  full_join(worldbank_data_clean, by=c("iso3c", "year")) %>% #we don't want to lose data
  full_join(life_expectancy_clean, by=c("iso3c", "year")) %>% #we don't want to lose data  
  left_join(select(countries, c("iso3c", "region")), by= c("iso3c")) #We don't want to lose values
