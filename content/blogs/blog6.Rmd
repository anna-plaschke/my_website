...
**(1) - Top 25 beer consuming countries**
...
ggplot(top25_beer, aes(x = reorder(country, desc(beer_servings)), y= beer_servings),)+
  geom_col(fill="blue") + #choosing type of plot and adding color
...
**(2) - Top 25 wine consuming countries**
...
**(3) -Top 25 spirit consuming countries**
