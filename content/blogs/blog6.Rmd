...
Namibia, France and Grenada have the largest per capita consumption of beer, wine and spirits, respectively. Unsurprisingly, these countries are some of the largest producers of the alcohols they consumed most. While I are familiar with French wine production, releasing 7-8 billion bottles per year, less known is Namibian ('German') beer production or Granadian spirit (read 'Rum') production figures. 
...
p1 + p2
```
Looking at the alcohol consumption behavior in Germany and Italy the stereotypes are not that wrong at all in the end. In Germany beer is the alcohol that is consumed most, and in Italy wine.
